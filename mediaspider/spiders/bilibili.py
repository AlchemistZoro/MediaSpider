...
from mediaspider.items import VideoInfoItem,ReplyInfoItem
import json
import logging
import requests
import re
import time
# def GetArchivecount(mid):
#     userinfo=GetUserInformation(mid)
#     archivecount=int(re.search(".*\"archive_count\":(\d+),",userinfo).group(1))
#     return archivecount

# def GetUserInformation(mid):
#     url='http://api.bilibili.com/x/web-interface/card?mid={}'.format(mid)
#     userinfo=GetHTMLContent(url)
#     return userinfo
